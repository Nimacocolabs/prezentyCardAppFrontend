...
class DealsProductList extends StatefulWidget {
  DealsProductList({required this.cardType});
  final String cardType;

  @override
  _DealsProductListState createState() => _DealsProductListState();
}

class _DealsProductListState extends State<DealsProductList> {
  List<Data> products = [];
  String? nextPageUrl;
  ...
  Future<void> fetchData() async {
    final response = await apiClient.getJsonInstance().post(
        nextPageUrl ?? Apis.ViewDealsProduct,
        data: {"cardType": widget.cardType});
